...
if __name__ == "__main__":
    ...
    # Opposite behavior and mean within some threshold same
    ...
    Ua = UGate("Ua", unitary)
    print(Ua.name, Ua.inverse)
    print(Ua.__array__)
    # print(Ua)
    # Uadag = UAGate(label="Uadag")
    # Ub = UBGate(label="Ub")
    # Uc = UCGate(label="Uc")
    ...
    for _ in range(100):
        ...
        for p in range(points):
            ...
            qc01 = equivalent_decomposition(qc0,agent_prelim_gateset)
            qc02 = equivalent_decomposition(qc0,agent_proposed_gateset)
            choi0 = Choi(qc0)
            choi01 = Choi(qc01)
            choi02 = Choi(qc02)
