...
def gen_dataset_rndS(dimensions = 1, samples = 100):
    ds = []
    for i in range(samples):
...
def vis_dataset_S(dimensions = 1):
    b = qt.Bloch()
    b.point_marker = ['o']
    b.point_size = [20]
    samples = 500
...
if __name__ == "__main__":
    ...
    vis_dataset_S()
    # print("Choose Task:")
    # print("  Option 1 - Compare GS1 and GS2")
    # print("  Option 2 - Generative novel gate set w.r.t. GS1")
    # yaqq_task = input("  ===> Enter choice: ")

    # print("Choose Data Set:")
    # print("  Option 1 - Evenly distributed states on Bloch sphere (Fibonacci )")
    # print("  Option 2 - Haar random unitaries")
    # yaqq_data = input("  ===> Enter choice: ")

    # # https://qiskit.org/documentation/stubs/qiskit.quantum_info.random_unitary.html

    # # ask how to make general 2 qubit gate with 15 free parameters
